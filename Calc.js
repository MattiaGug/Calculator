...
const tempResultE1 = document.querySelectorAll('.temp-result');
const operationE1 = document.querySelectorAll('.operation')
const numbersE1 = document.querySelectorAll('.operation');
...
/* se ho il punto la calcolatrice non deve aggiungerne un altro */
